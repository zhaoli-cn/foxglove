 ...
 * @author L.cm
 */
public class ZiExpressionEvaluator extends CachedExpressionEvaluator {
	...
	public EvaluationContext createContext(Method method, Object[] args, Object target, Class<?> targetClass, @Nullable BeanFactory beanFactory) {
		...
		ZiExpressionRootObject rootObject = new ZiExpressionRootObject(method, args, target, targetClass, targetMethod);
