...
import com.zl.core.tool.beans.BeanProperty;
import com.zl.core.tool.beans.ZiBeanCopier;
import com.zl.core.tool.beans.ZiBeanMap;
import com.zl.core.tool.convert.ZiConverter;
...
public class BeanUtil extends org.springframework.beans.BeanUtils {
	...
	public static <T> T copy(@Nullable Object source, Class sourceClazz, Class<T> targetClazz) {
		...
		ZiBeanCopier copier = ZiBeanCopier.create(sourceClazz, targetClazz, false);
	...
	public static void copy(@Nullable Object source, @Nullable Object targetBean) {
		...
		ZiBeanCopier copier = ZiBeanCopier
	...
	public static <T> T copyWithConvert(@Nullable Object source, Class<?> sourceClazz, Class<T> targetClazz) {
		...
		ZiBeanCopier copier = ZiBeanCopier.create(sourceClazz, targetClazz, true);
		T to = newInstance(targetClazz);
		copier.copy(source, to, new ZiConverter(sourceClazz, targetClazz));
		return to;
	}
