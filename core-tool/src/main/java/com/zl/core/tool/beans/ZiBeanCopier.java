...
import com.zl.core.tool.utils.BeanUtil;
import com.zl.core.tool.utils.ClassUtil;
import com.zl.core.tool.utils.ReflectUtil;
import com.zl.core.tool.utils.StringUtil;
 ...
 * @author L.cm
 */
public abstract class ZiBeanCopier {
	private static final Type CONVERTER = TypeUtils.parseType("org.springframework.cglib.core.Converter");
	private static final Type BEAN_COPIER = TypeUtils.parseType(ZiBeanCopier.class.getName());
	...
	/**
	 * The map to store {@link ZiBeanCopier} of source type and class type for copy.
	 */
	private static final ConcurrentMap<ZiBeanCopierKey, ZiBeanCopier> BEAN_COPIER_MAP = new ConcurrentHashMap<>();

	public static ZiBeanCopier create(Class source, Class target, boolean useConverter) {
		return ZiBeanCopier.create(source, target, useConverter, false);
	}

	public static ZiBeanCopier create(Class source, Class target, boolean useConverter, boolean nonNull) {
		ZiBeanCopierKey copierKey = new ZiBeanCopierKey(source, target, useConverter, nonNull);
	...
	public static class Generator extends AbstractClassGenerator {
		private static final Source SOURCE = new Source(ZiBeanCopier.class.getName());
		...
		@Override
		public ZiBeanCopier create(Object key) {
			return (ZiBeanCopier) super.create(key);
		}
